...
def addText(image, text, inputs='background.jpg', font='Royal.ttf', fontsize=20, x=300, y=300):
	text = text.replace('\n', ' ').replace('\t', ' ')
...
if __name__ == '__main__':
	addText('the_show/test/backup.jpg', 'testing to see if this works testing to see if this works testing to see if this works')
